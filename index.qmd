...
```{ojs}
viewof annee = Inputs.checkbox(
  ["2022", "2023", "2024", "2025"],
  {label: "Année", disabled: ["2022", "2023", "2024"], value: ["2025"]}
)
```
...
```{ojs}
embeddedPDF = pdfView(
  "https://minio.lab.sspcloud.fr/lgaliana/data/cahier-technique-dsn/cahier2025.pdf",
  {
    startPage: content.data.page,
    scale: 1
  })
```
...
```{ojs}
import {pdfView} from "@linogaliana/pdf-view"
```
